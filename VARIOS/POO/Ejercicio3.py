...
class Moto(Fabrica):
    def datos(self):
        print("La cantidaad de llantas de la moto es: ", self.llantas)
        print("El color de la moto es: $", self.color)
        print("El precio de la moto es: ", self.precio)

moto = Moto(2, "Azul", 4000)
moto.datos()

carro = Carro(4, "Negro", 50000)
carro.datos()